...
(function () {
  ...
  window.CALC_HQ_NETWORK = [
    ...
    { name: "1099vsW2Calc.com",       url: "https://salaryvsinflation.com",    live: true,  clusters: ["us", "tax-income"] },
  ...
  function renderFooter() {
    ...
    footerTarget.innerHTML = [
      ...
      '</div>',
      '<p class="footer-meta">1099vsW2Calc.com · Estimates run locally in your browser.</p>'
    ].join('');
  }
